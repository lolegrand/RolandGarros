...
public class PlayerDAOMock implements PlayerDAO {
    ...
    Player p1 = new Player("ALCARNAZ", "Carlos", P1Birth, "ElPalmar, Murcia, Spain", 1, 1, "Spanish", 182f, 74f, 2018, Hand.RIGHT_HANDED, P1Coach);
    Player p2 = new Player("NADAL", "Rafael", P2Birth, "Manacor, Mallorca, Spain", 2, 1, "Spanish", 185f, 84f, 2001, Hand.LEFT_HANDED, P2Coach);
    Player p3 = new Player("RUUD", "Casper", P3Birth, "Oslo, Norway", 3, 2, "Norwegian", 182f, 77f, 2015, Hand.RIGHT_HANDED, P3Coach);
    Player p4 = new Player("MEDVEDEV", "Daniil", P4Birth, "Moscow, Russia", 4, 3, "Russian", 198f, 82f, 2014, Hand.RIGHT_HANDED, P4Coach);
