...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        PlayerService.createPlayer(new Player("fefe", "trainer", Date.valueOf("1980-12-11"), "Tamanrasset", 1, 1, "Bangladech", 1.80f, 80f, Date.valueOf("2015-12-11"), Hand.RIGHT_HANDED, person, Gender.MALE));
